...
function findFormKey(aquaData: object, key: string) {
...
function updateForm(filename_par: string, key: string, content: string | undefined = undefined) {
  ...
  // const targetRevisionHash  : string = Object.keys(revisions).pop();
  ...
  const targetRevision: object = revisions[targetRevisionHash];
